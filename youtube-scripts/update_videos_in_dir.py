...
if __name__ == "__main__":
    ...
    if (args.workDir is None):
        print("Usage : python update_videos.py --workdDir <workDir> --maxCount <maxCount> --channelId <channelId> --outDir <outDir>")
        sys.exit(0)
    ...
    download_videos(youtube=youtube, input_file='liked.json', work_dir=args.workDir, start=None, end=None, out_dir=args.outDir)
